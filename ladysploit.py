...
'''def ColoringModeStartup():
    ...
    if "NOT_LOADED" in line:
     platform_choice = input("Welcome to LadySploit! Are you loading this script in (W)indows or (L)inux: ")
...
|    |   _____     __| _/__.__./   _____/_____ |  |   ____ |__|/  |_ 
|    |   \__  \   / __ <   |  |\_____  \\____ \|  |  /  _ \|  \   __\
|    |___ / __ \_/ /_/ |\___  |/        \  |_> >  |_(  <_> )  ||  |  
|_______ (____  /\____ |/ ____/_______  /   __/|____/\____/|__||__|  
        \/    \/      \/\/            \/|__|                         
'''.format(Fore.GREEN, Fore.WHITE, Fore.RED)
...
| $$       /$$__  $$| $$  | $$| $$  | $$ /$$  \ $$| $$  | $$| $$| $$  | $$| $$  | $$ /$$
| $$$$$$$$|  $$$$$$$|  $$$$$$$|  $$$$$$$|  $$$$$$/| $$$$$$$/| $$|  $$$$$$/| $$  |  $$$$/
|________/ \_______/ \_______/ \____  $$ \______/ | $$____/ |__/ \______/ |__/   \___/  
                               /$$  | $$          | $$                                  
                              |  $$$$$$/          | $$                                  
                               \______/           |__/                                  
...
def main():
    page_num = 1
    option = input(Fore.WHITE + "ladysploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
    if option == '1':
        ...
        ip = input(arrow+" ladysploit"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
        os.system("adb connect "+ip+":5555")
    
    elif option  == '4':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(shell_on_phone) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell")

    elif option == '5':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter the apk location.").format(Fore.RED, Fore.WHITE))
        apk_location = input("    "+arrow + "ladysploit"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
        os.system("adb -s  "+device_name+" install "+apk_location)
        print (Fore.GREEN  +  "Apk has been installed.")

    elif option ==  '6':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        place_location = input("    "+arrow + "ladysploit"+Fore.RED + "(screen_record) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull /sdcard/demo.mp4 "+place_location)

    elif option  == '7':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        place_location = input("    "+arrow + "ladysploit"+Fore.RED + "(screenshot) "+Fore.WHITE + "> ")
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a file location on a device").format(Fore.RED, Fore.WHITE))
        file_location = input("    "+arrow + "ladysploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        print (("        "+connect))
        print (("       [{0}+{1}]Enter where you would like the file to be saved.").format(Fore.RED, Fore.WHITE))
        place_location = input("       "+arrow + "ladysploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" pull "+file_location+" "+place_location)

    elif option == '10':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(device_reboot) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+ " reboot ")
    
    elif option ==  '11':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name.").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "ladysploit"+Fore.RED + "(app_delete) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" unistall "+package_name)

    elif option == '12':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(log) "+Fore.WHITE + "> ")
        os.system('adb -s '+device_name+" logcat ")

    elif option == '13':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(sys_info) "+Fore.WHITE + "> ")
        os.system("adb shell "+device_name+" dumpsys")        

    elif option == '14':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(package_manager) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell pm list packages -f")
        main()

    elif option == '15':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "ladysploit"+Fore.RED + "(app_run) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell monkey -p "+package_name+" -v 500")
        main()      

    elif option == '16':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a port on the device.").format(Fore.RED, Fore.WHITE))
        port_device = input("    "+arrow + "ladysploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        print (("         "+connect))
        print (("        [{0}+{1}]Enter a port to forward it too.").format(Fore.RED, Fore.WHITE))
        forward_port = input("        "+arrow + "ladysploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
        ...
        try:
            ...
            device_name = input(arrow + "ladysploit"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")
            ...
            location = input("    "+arrow + "ladysploit"+Fore.RED + "(wpa_grab) "+Fore.WHITE + "> ")      
        ...
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(mac_inet) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell ip address show wlan0")
        main()

    elif option == '19':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("     "+connect))
        print (("    [{0}+{1}]Enter a package name. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
        package_name = input("    "+arrow + "ladysploit"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        ...
        path = input("        "+arrow + "ladysploit"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        print (("             "+connect))
        print (("            [{0}+{1}]Enter The location to store the apk: ")  .format(Fore.RED, Fore.WHITE))
        location =   input("            "+arrow + "ladysploit"+Fore.RED + "(pull_apk) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+" pull "+path+" "+location)
        main()

    elif option == '20':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(battery) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell dumpsys battery")
        main()

    elif option == '21':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(net_stat) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " shell netstat")
        main()

    elif option == '22':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(wifi) "+Fore.WHITE + "> ")
        print (("     "+connect))
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(pass_remove) "+Fore.WHITE + "> ")
        ...
        print (("[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        print ('''
0 -->  "KEYCODE_UNKNOWN" 
1 -->  "KEYCODE_MENU" 
...
85 -->  "TAG_LAST_KEYCODE"        
        ...
        num = input(arrow + "ladysploit"+Fore.RED + "(keycode) "+Fore.WHITE + "> ")
        os.system("adb -s "+device_name+" shell input keyevent "+num)

    elif option == '25':
        print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
        device_name = input(arrow + "ladysploit"+Fore.RED + "(current_activity) "+Fore.WHITE + "> ")
        os.system("adb -s " +device_name+ " dumpsys activity")
        main()
    
    elif option == '26':
            print (("\n[{0}+{1}]Enter a device name.").format(Fore.RED, Fore.WHITE))
            device_name = input(arrow + "ladysploit"+Fore.RED + "(file_push) "+Fore.WHITE + "> ")
            print (("     "+connect))
            print (("    [{0}+{1}]Enter a file location on PC").format(Fore.RED, Fore.WHITE))
            file_location = input("    "+arrow + "ladysploit"+Fore.RED + "(file_push) "+Fore.WHITE + "> ")
            print (("        "+connect))
...
def main_linux():
    ...
    try:
        device_name = input (arrow+" ladysploit"+Fore.RED + "(connect_phone) "+Fore.WHITE + "> ")
    except KeyboardInterrupt:
        main()
    if device_name == '':
        main()
    ...
    85 -->  "TAG_LAST_KEYCODE"
            ...
            print (("        "+connect))
            print (("       [{0}+{1}]Enter where you would like the file to be saved.[Default: /sdcard/ ]").format(Fore.RED, Fore.WHITE))
            place_location = input("       "+arrow + "ladysploit"+Fore.RED + "(file_push) "+Fore.WHITE + "> ")
            os.system("adb -s "+device_name+" push "+file_location+ " /sdcard/" + place_location)
            option = input(Fore.WHITE + "ladysploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
